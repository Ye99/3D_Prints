...
// This is outer diameter. Wall thickness will be subtracted. 
// Must match small_end base diameter. Don't have time to refactor these two parts to be 
// more maintainable. Too many fun projects to do!
// Can be imporved:
// 1. Extract adapotr as a module that takes parameters and thus eliminate two duplicate modules. 
// 2. Define named constant and thus guarantee base diameter is shared between two ends. 
Base_diameter  = 83.5;
