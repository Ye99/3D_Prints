...
Top_Style = "base_sm"; // [base_sm:Plain - Single Material, base_mm2:Plain - Two Materials, logo_sm:Logo - Single Material, logo_mm2:Logo - Two Materials, logo_mm3:Logo - Three Materials, hex_sm:Hexagons - Single Material, hex_mm2:Hexagons - Two Materials, slots_sm:Slots - Single Material, mesh_sm:Mesh - Single Material, pihole_sm:Pi-hole Logo - Single Material, pihole_mm4:Pi-hole Logo - Four Materials]
...
Left_Style = "slots"; // [none>:None, rear_slots:Rear Slots, slots:Slots, mesh:Mesh]

// Right

Right_Style = "slots"; // [none>:None, rear_slots:Rear Slots, slots:Slots, mesh:Mesh]

/* [Fan Features] */

Fan_Type = "40mm"; // [30mm, 40mm]
Fan_Hole = true;
Fan_Mounting = "screws"; // [none:None, screws:Screws, rails:Rails]
