...
module case_mesh() {
    ...
    if (Extended_Height) {
        ...
        if (Top_Style == "logo_mm3") {
            import("z_top_h20_style_logo_mm3_c3_base.stl");
        } else if (Top_Style == "pihole_mm4") {
            import("z_top_h20_style_pihole_mm4_c3_base.stl");
        }
        
    } else {
    
        if (Top_Style == "logo_mm3") {
            import("z_top_style_logo_mm3_c3_base.stl");
        } else if (Top_Style == "pihole_mm4") {
            import("z_top_style_pihole_mm4_c3_base.stl");
        }
